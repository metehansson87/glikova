  ...
  return (
    <div className="app-shell">
      ...
      <main className="app-main">
        ...
        {activeTab === "settings" && (
          <SettingsPage lang={lang} setLang={setLang} isPremium={isPremium} darkMode={darkMode} onToggleDark={() => setDarkMode(d => !d)} onSignOut={handleSignOut} />
        )}
      </main>
      ...
      <nav className="bottom-nav">
        ...
        <button className={activeTab === "premium" ? "nav-item active nav-item-premium" : "nav-item nav-item-premium"} onClick={() => setActiveTab("premium")}>
          ...
          <span>{isPremium ? "✓ Pro" : lang === "tr" ? "Premium" : "Premium"}</span>
        </button>
      </nav>
    </div>
  );
