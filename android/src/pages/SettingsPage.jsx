...
export default function SettingsPage({ lang, setLang, isPremium, darkMode, onToggleDark, onSignOut }) {
  ...
  const L = {
    en: {
      ...
      upgradeDesc: "Unlock full history for a one-time payment of ₺50",
    ...
    tr: {
      ...
      upgradeDesc: "Tek seferlik ₺50 ödemeyle tüm geçmişin kilidini aç",
